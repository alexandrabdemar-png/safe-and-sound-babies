      ...
      <main className="flex-1 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-10 space-y-8 font-body text-base leading-relaxed text-foreground">
            ...
            <section>
              <h2 className="font-display text-xl font-semibold text-foreground">7. AI-Generated Content</h2>
              <p className="mt-2 text-muted-foreground">
                Some product safety guidelines and size-up estimates in Peace of Mine are generated by artificial intelligence. AI-generated content may be incomplete, incorrect, or out of date. Always verify safety information with the product manufacturer, a certified child passenger safety technician, or your pediatrician. AI-generated guidelines are estimates only — not authoritative safety specifications.
              </p>
            </section>

            <section>
              <h2 className="font-display text-xl font-semibold text-foreground">8. Recall Data Limitations</h2>
              <p className="mt-2 text-muted-foreground">
                Recall information is sourced from the CPSC and FDA databases and may not reflect all current or past recalls. The absence of a result does not mean a product is safe or unrecalled. Always check the official recall database at{" "}
            ...
            <section>
              ...
              <p className="mt-2 text-muted-foreground">
                If you have questions about these Terms, reach out to us at support@peaceofmineapp.com.
              </p>
            </section>
          </div>
        </div>
