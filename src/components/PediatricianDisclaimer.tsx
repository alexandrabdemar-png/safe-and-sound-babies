...
export function PediatricianDisclaimer({
  ...
  const copy =
    variant === "recall"
      ? "Recall data is aggregated from official sources (CPSC, FDA, NHTSA, USDA FSIS). \"No active recalls found\" reflects the last successful sync only. Verify with the manufacturer and cpsc.gov/Recalls before relying on it for safety-critical decisions."
      : variant === "compact"
