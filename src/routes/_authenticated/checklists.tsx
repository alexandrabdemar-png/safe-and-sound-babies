...
const ROOMS: Room[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "lr_small_objects_away", label: "Small objects (coins, batteries) out of reach", minAgeMonths: 4 },
      ...
      { key: "lr_remote_batteries", label: "Remote control battery covers secured", minAgeMonths: 6 },
    ],
  },
  {
    id: "kitchen",
    label: "Kitchen",
    items: [
      { key: "kitchen_cabinet_locks", label: "Child locks on lower cabinet doors", minAgeMonths: 6 },
      { key: "kitchen_cleaning_products_high", label: "Cleaning products stored high or locked", minAgeMonths: 6 },
      ...
      { key: "kitchen_dishwasher_latched", label: "Dishwasher door stays latched", minAgeMonths: 6 },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "bath_razors_away", label: "Razors and sharp items stored out of reach", minAgeMonths: 9 },
      { key: "bath_cosmetics_away", label: "Cosmetics and toiletries out of reach", minAgeMonths: 9 },
